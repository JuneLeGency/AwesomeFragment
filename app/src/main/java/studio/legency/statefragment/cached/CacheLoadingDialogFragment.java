...
public abstract class CacheLoadingDialogFragment<T> extends
        CacheLoadingFragment<T> implements DialogInterface.OnCancelListener,
     ...
     *              {@link #STYLE_NO_INPUT}.
     * @param theme Optional custom theme. If 0, an appropriate theme (based on
     ...
     * FragmentTransaction.commitAllowingStateLoss()}. See linked documentation
     * for further details.
     */
     ...
     * will be true.
     *
     * @param showsDialog If true, the fragment will be displayed in a Dialog. If false,
